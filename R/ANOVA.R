...
loop_BC_LC$BC_LC <- log10(loop_BC_LC$BC_LC)
...
beepr::beep()
write.csv(ICC_table, "D:/Dropbox/APMfull/MAL_CNG_Paper/KAN/ICC_log10.csv")
...
beepr::beep()
write.csv(ICC_table, "D:/Dropbox/APMfull/MAL_CNG_Paper/CBD/ICC_log10.csv")
